...
ANSWER_PART_1_EXAMPLE = 161
ANSWER_PART_2_EXAMPLE = 48
ANSWER_PART_1 = 188741603
ANSWER_PART_2 = 67269798


def test_part_1_example():
    solver = Solver()
    data_file_path = os.path.join(os.environ.get('TEST_RESOURCES_DIR_PATH'),
                                  f'day{solver.get_day()}-part-1-example.data')
...
def test_part_2_example():
    solver = Solver()
    data_file_path = os.path.join(os.environ.get('TEST_RESOURCES_DIR_PATH'),
                                  f'day{solver.get_day()}-part-2-example.data')
